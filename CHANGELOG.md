...
- [Pull request #385: Set aria-activedescendant to automatically selected option when using autoselect](https://github.com/alphagov/accessible-autocomplete/pull/380)
